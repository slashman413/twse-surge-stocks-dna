...
<div class="container">
  ...
  <div style="background:#3a1d1d;border:1px solid #b91c1c;border-radius:12px;padding:12px 16px;margin:0 0 16px;color:#fecaca;font-size:.82rem;line-height:1.6;text-align:center;">
    ⚠️ <strong>本資訊僅供教育參考，非投資建議</strong>；以下為量化條件篩選結果，非買賣推薦。回測為假設情境，過去或模擬績效不代表未來結果。任何投資決策與風險請自行判斷並承擔。
  </div>
  ...
  <h2 class="section-title" style="color:#22c55e">🟢 符合買進條件 ({output.get('buy_count', 0)}檔)</h2>
  <table>
  ...
  <h2 class="section-title" style="color:#ef4444;margin-top:24px;">🔴 符合賣出條件 ({output.get('sell_count', 0)}檔)</h2>
  <table>
    <tr><th>代號</th><th>名稱</th><th>收盤</th><th>評分</th><th>RSI14</th><th>乖離MA20</th><th>條件</th></tr>
